...
class DeleteContactsTermsScreenTest {
    ...
    fun parseDeleteContactsAgreement_validAgreement_parsesStructuredSections() {
        val agreement = parseDeleteContactsAgreement(
            "Пользовательское соглашение по установке PIN-кода для удаления адресной книги " +
                    "крипто-адресов.<br/><br/>\n" +
                    "Устанавливая PIN-код, вы подтверждаете, что понимаете его назначение как механизма " +
                    "защиты вашей конфиденциальности.<br/>\n" +
                    "<b>1. Защитная функция PIN-кода</b><br/>\n" +
                    "Данный PIN-код предназначен для экстренного удаления адресной книги " +
                    "крипто-адресов.<br/>\n" +
        ...
        assertEquals(
            "Устанавливая PIN-код, вы подтверждаете, что понимаете его назначение как механизма защиты вашей " +
                    "конфиденциальности.",
            agreement.intro
        )
    ...
    fun parseDeleteContactsAgreement_missingSections_returnsNull() {
        val agreement = parseDeleteContactsAgreement(
            "Пользовательское соглашение<br/><br/>" +
                    "Текст без структурированных пунктов."
        )
