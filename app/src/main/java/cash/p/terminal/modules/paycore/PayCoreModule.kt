...
val payCoreModule = module {
    ...
    singleOf(::PayCoreBanksRepository)
    singleOf(::PayCoreFeatureToggle)
    singleOf(::PayCoreSecureStorage)
    singleOf(::PayCoreWalletApprovalService)
    ...
    viewModel { params -> PayCoreVerificationViewModel(params[0], params[1], get(), get(), get(), get(), get()) }
    viewModel { params -> PayCorePaymentViewModel(get(), get(), get(), get(), params.get<PayCorePaymentParams>()) }
