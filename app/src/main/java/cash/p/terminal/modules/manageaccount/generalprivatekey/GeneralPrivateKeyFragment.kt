package cash.p.terminal.modules.manageaccount.generalprivatekey
...
class GeneralPrivateKeyFragment : BaseComposeFragment(screenshotEnabled = false) {

    @Parcelize
    data class Input(val privateKey: String, val title: String) : Parcelable
...
@Composable
private fun GeneralPrivateKeyScreen(
    navController: NavController,
            ...
            ConfirmCopyBottomSheet(
                onConfirm = {
                    coroutineScope.launch {
                        TextHelper.copyText(generalPrivateKey)
