...
class OfflineSignedTransactionRepository(
    ...
    private fun OfflineSignedTransactionDraft.toEntity(pcashPayload: String): OfflineSignedTransactionEntity {
        ...
        return OfflineSignedTransactionEntity(
            ...
            stellarSourceAccountId = stellarRetryMetadata?.sourceAccountId,
            stellarSequenceNumber = stellarRetryMetadata?.sequenceNumber,
            stellarValidUntil = stellarRetryMetadata?.validUntil,
            toAddress = toAddress,
            rawHex = rawHex,
