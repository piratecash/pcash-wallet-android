...
object DumpManager {
    ...
    fun getInitialDump(
        ...
        blockchains.forEach { blockchain ->
            ...
            val insertQuery =
                "INSERT OR REPLACE INTO BlockchainEntity VALUES(${sqlEscape(blockchain.uid)},${sqlEscape(blockchain.name)},$eipUrl);"
        ...
        tokens.forEach { token ->
            ...
            val insertQuery =
                "INSERT OR REPLACE INTO TokenEntity VALUES(${sqlEscape(token.coinUid)},${sqlEscape(token.blockchainUid)}," +
